...
class AgentTraceTest(unittest.TestCase):
    def test_trace_exposes_durable_three_agent_two_node_path_and_causal_refs(self):
        ...
        self.assertTrue({
            ...
            "PLANNER_CONTEXT", "GENERATION_PLAN",
        ...
        self.assertIn("GENERATION_PLANNED", event_types)
        ...
        self.assertEqual(8, trace["summary"]["generation_plan_count"])
        self.assertGreaterEqual(trace["summary"]["trace_record_count"], 9)
