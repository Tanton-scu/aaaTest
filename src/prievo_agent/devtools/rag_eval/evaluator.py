...
from prievo_agent.knowledge.literature.retrieval.hybrid import LocalHybridLiteratureRAG
...
def main(argv=None):
    ...
    parser.add_argument(
        "--corpus", type=Path, default=project / "assets" / "literature" / "corpus.json"
    )
    parser.add_argument(
        "--cases", type=Path, default=project / "assets" / "literature" / "eval_cases.json"
    )
    parser.add_argument(
