"""PriEvO Agent / Node 的独立、白名单式 Context Policy。
...
class PlannerContextPolicy(BaseContextPolicy):
    """Planner 只看策略选择所需状态与上一次决策反馈。"""

    name = "planner"
    rules = (
        _FieldRule("task", "Task / budget contract", "Contract"),
        _FieldRule("phase", "Current generation phase", "Runtime"),
        _FieldRule("population_summary", "Current population summary", "Population"),
        _FieldRule("population_ranking", "Population ranking", "Population"),
        _FieldRule("strategy_statistics", "Strategy outcome statistics", "Outcomes"),
        _FieldRule("previous_plan_feedback", "Previous plan feedback", "Feedback"),
        _FieldRule(
            "planner_memory", "Recent planner memory", "Memory",
            channel=RECENT, max_items=6, keep_recent=True,
        ),
        _FieldRule("allowed_strategies", "Allowed PriEvO strategies", "Contract"),
        _FieldRule("allowed_parent_policies", "Allowed parent policies", "Contract"),
        _FieldRule("output_schema", "GenerationPlan schema", "Contract"),
    )
...
def _policy_name(value):
    ...
    aliases = {
        "similarityselectionnode": "similarity",
        "similarity_selection_node": "similarity",
        "similarityagent": "similarity",
        "similarity_agent": "similarity",
        "evolutionplannernode": "planner",
        "evolution_planner_node": "planner",
        "evolutionplanneragent": "planner",
        "evolution_planner_agent": "planner",
        ...
        "literatureevidenceresolver": "research",
        "literature_evidence_resolver": "research",
        "repairagent": "repair",
        "repair_agent": "repair",
        "finalselectionagent": "final_selection",
        "final_selection_agent": "final_selection",
        "finalselectionnode": "final_selection",
        "final_selection_node": "final_selection",
