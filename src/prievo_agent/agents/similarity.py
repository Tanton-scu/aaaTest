"""PriEvO numeric Top-5 之后的受约束语义筛选 Agent。"""
...
class SimilarityAgent:
    ...
    def select(
        ...
        if self.model is None or not hasattr(
            ...
            raise SimilarityAgentError("SimilarityAgent 未配置 semantic selection model")
    ...
    def _build_prompt(context_text: str) -> str:
        return (
            "You are SimilarityAgent. Select historical instances whose fitness "
